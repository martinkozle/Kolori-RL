...
namespace GJP2021.Sources
{
    ...
    {
        public static void DrawOutlinedText(SpriteBatch spriteBatch, SpriteFont font, string text, Vector2 position, Color backColor, Color frontColor, float scale=1F)
        {
